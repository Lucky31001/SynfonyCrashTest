 ...
 */
final class Version20241001060554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT NOT NULL, title VARCHAR(255) NOT NULL, content VARCHAR(255) DEFAULT NULL, image VARCHAR(1024) DEFAULT NULL, fav INT DEFAULT 0 NOT NULL, price INT NOT NULL, tva INT NOT NULL, PRIMARY KEY(id))');
